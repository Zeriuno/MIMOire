...
Le champ d'application, comme le soulignent les éthologues, est tout simplement immense [Theraulaz, Bonabeau, 1999].
...
On pourrait considérer que les concepts de résilience ainsi que celui de stigmergie ne font que recouvrir un ensemble d'outils et pratiques déjà couramment adoptés, existants, conçus ou bien souhaités. Le fait de les encadrer conceptuellement, dans leur buts communs, dans leurs modalités et leurs parentés n'est cependant pas anondin: c'est ainsi qu'on peut les connaître comme éléments non plus isolés, mais participant d'une même réalités, facettes différentes du polyèdre qu'elles participent à construire. Tel Adam prenant possession de la création par le fait de nommer les espèces, nous transformons le constat de l'existant en un puissant outil épistémologique, nous renouvellons notre capacité gnoséologique, notre regard.
