...
Si ici les auteurs prennent garde de souligner la possibilité que le système d'information soit constitué d'une technologie rudimentaire, il est cependant intéressant de remarque que d'autres considèrent que sans «\thinspacecodes sources binaires [sic] les ordinateurs ne fonctionneraient plus, ils ne pourraient même pas s’appeler ordinateurs et il n’y aurait plus de système d’information\thinspace» ([Lequeux, Challande, 2009].
...
En effet, cette définition touche au cas de «\thinspacerésilience de préparation\thinspace» ou même «\thinspacede confrontation\thinspace».
...
Que ceux-ci aient fait déjà l'objet d'études et théorisation nous confirme leur intérêt ; mais, plus encore, le fait de pouvoir les encadrer de manière plus large avec la «\thinspacerésilience de récupération\thinspace» nous confirme l'utilité d'une approche multidisciplinaire capable d'apporter un questionnement nouveau et enrichissant.
...
[Le Blanc, Nicolas, 2013] Antoine Le Blanc, Thierry Nicolas, «\thinspacePolitiques et pratiques de la résilience\thinspace», *EchoGéo* [Online], 24, [http://echogeo.revues.org/13451](http://echogeo.revues.org/13451), 2013.\newline
